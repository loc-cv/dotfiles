...
_G.packer_plugins = {
  ...
  ["fzf-lua"] = {
    ...
    loaded = true,
    path = "/home/colcv/.local/share/nvim/site/pack/packer/start/fzf-lua",
...
try_loadstring("\27LJ\2\2Y\0\0\2\0\3\0\0066\0\0\0'\1\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0 setup_context_commentstring\26plugins.configs.miscs\frequire\0", "config", "nvim-ts-context-commentstring")

vim.cmd [[ packadd nvim-ts-autotag ]]

-- Config for: nvim-ts-autotag
try_loadstring("\27LJ\2\2K\0\0\2\0\3\0\0066\0\0\0'\1\1\0B\0\2\0029\0\2\0B\0\1\1K\0\1\0\18setup_autotag\26plugins.configs.miscs\frequire\0", "config", "nvim-ts-autotag")
...
vim.cmd [[au BufNewFile * ++once lua require("packer.load")({'indent-blankline.nvim', 'pounce.nvim', 'vim-textobj-entire', 'vim-searchlight', 'vim-sandwich', 'vim-highlightedyank', 'is.vim', 'vim-better-whitespace', 'FixCursorHold.nvim', 'vim-move', 'nvim-colorizer.lua', 'vim-polyglot', 'vim-easy-align', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufNewFile *" }, _G.packer_plugins)]]
...
vim.cmd [[au BufRead * ++once lua require("packer.load")({'indent-blankline.nvim', 'pounce.nvim', 'vim-textobj-entire', 'vim-searchlight', 'vim-sandwich', 'vim-highlightedyank', 'is.vim', 'vim-better-whitespace', 'FixCursorHold.nvim', 'vim-move', 'nvim-colorizer.lua', 'vim-polyglot', 'vim-easy-align', 'gitsigns.nvim', 'Comment.nvim'}, { event = "BufRead *" }, _G.packer_plugins)]]
