...
local options = {
  ...
  updatetime = 20, -- long updatetime leads to poor user experience
  ...
  sessionoptions = 'blank,buffers,curdir,folds,help,tabpages,winsize,winpos,terminal,globals', -- some session options that I don't understand :)
